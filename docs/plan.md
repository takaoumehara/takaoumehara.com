...
- 2026-08-23: Froze source commit `bd34c25`, then passed the syntax, 7-test unit, 13-test browser, and 4-test link suites twice from fresh servers/contexts. Stored desktop, mobile, and open-dialog visual evidence plus `docs/verification.md`.
