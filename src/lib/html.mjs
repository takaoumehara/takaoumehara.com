// Tiny HTML helpers for the Astro components. The site's strings are
// `string | { en, jp }`; t() and tb() turn them into the EN/JP span pair the
// language switch relies on. Components print them with set:html.
...
/** Site-relative path ("projects/x.html", "assets/…") → root-absolute URL. External URLs, mailto:, tel: and #anchors pass through. */
