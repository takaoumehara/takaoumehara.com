...
export function draftLens({ company, slug, analysis, picks, lib, lexicon, source, scored = [], requirements = [], seenAt }) {
  ...
  return fixJapaneseSpacing({
    $comment: `DRAFT generated by scripts/generate-pitch.mjs from ${source}. Rewrite hero.body and the ledes in your own voice; keep the ids. Set status to "published" and run node src/build.mjs to publish at /lens/${slug}.`,
    slug,
    title: `${company} — ${title}`,
